...
const RingsComponentMini = ({ fillValue }: { fillValue: number[] })=> {
  const radiusArray = [5, 10, 15, 20]; // Define your radius array
  const strokeWidth = 4; // Define your stroke width
...
export default RingsComponentMini;
